...
int main() 
{
    ...
    string testString = "My name is Mira"; // to hold the string that we want to test the sum_ascii() function with
    ...
    cout << "The sum of the string's character's ASCII values is equal to " << testResult << endl; // output the results
